 ...
 if(isset($_POST['insert_event'])){
    ...
    //  temp 
     ...
     if($event_title == "" or $desc == "" or $keywrd == "" or $eventType == "" or $Branch == "" or $fee == "" or $desc == "" or $image1 == "" or $image2 == "" ){
        ...
        $insert_events = "insert into `eventdetails` (title,description ,keywords ,eventtype,branch,image1,image2,fees,date ,status) values('$event_title','$desc','$keywrd','$eventType','$Branch','$image1','$image2','$fee',NOW(),'$st')";
